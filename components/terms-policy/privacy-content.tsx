...
import { ArrowUp, ChevronDown, Shield } from "lucide-react";
    ...
    <div className="bg-background min-h-[80vh]">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-14 md:py-20">
        <div className="max-w-2xl mx-auto text-center mb-12 md:mb-16">
          ...
          <h1 className="h1-text text-foreground">Privacy Policy</h1>
        ...
        {!html ? (
          <div className="max-w-2xl mx-auto text-center py-16 px-6 space-y-4 bg-card border border-border rounded-2xl">
            <Shield className="h-10 w-10 text-muted-foreground/40 mx-auto stroke-1" />

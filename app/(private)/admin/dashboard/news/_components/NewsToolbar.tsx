...
export default function NewsToolbar({ tableId }: NewsToolbarProps) {
    ...
    <div className="flex items-center justify-between">
      <div className="flex flex-col flex-1 gap-2">
        <div className="mb-2 flex items-start justify-between flex-wrap space-y-2">
          <div>
            <h2 className="font-dm-sans font-medium text-lg">Manage News</h2>
            <DynamicBreadcrumb items={breadcrumbItems} />
          </div>
          <Button size="sm" className="gap-1.5 text-white" asChild>
